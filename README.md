...
**Zeitplan-Kaskade, live verifiziert 2026-07-26** (P1/P2 alle 5h, P3–P9 stündlich, P8b täglich): `P1=:05(5h) → P2=:15(5h) → P3=:05 → P3d=:13 → P4=:21 → P3c=:28 → P5=:29 → P3e=:33 → P6=:37 → P7=:45 → P8=:52 → P9=:58` und separat `Paperless-Backfill=:00(1h)`, `P8b=täglich 06:00`. **Hinweis:** die tatsächliche Reihenfolge weicht inzwischen von der ursprünglich dokumentierten Absicht (P3→P3c→P3d→P3e→P4) ab — P3d läuft heute vor P4, P3c/P5/P3e danach. Nicht im Rahmen der Dokumentationsaktualisierung geprüft, ob das noch der beabsichtigten Datenabhängigkeit entspricht. Atomare Claim-/Lease-Sperren verhindern in P2, P3, P3c, P3d, P3e, P4–P9 sowie im Paperless-Backfill, dass parallele Läufe denselben Vorgang gleichzeitig bearbeiten. Ein Claim ersetzt keine fachliche Eingangsvoraussetzung und garantiert nicht den Abschluss der vorherigen Stufe.
